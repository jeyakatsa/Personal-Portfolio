...
<!-- Above information for social media sharing and search-engine/browser optimization -->	
	...
	<div id="entire-navbar"><nav id="navbar">
	  <header></header>
	  <ul>
	    <li><a class="nav-link" id="first" href="#Introduction">Introduction</a></li>
	    <li>
	    ...
	    <li><a class="nav-link" id="last" href="#Reference">Reference</a></li>
	  </ul>
	</nav>
	<header id="header"><p id="title">JavaScript</p>
	    <p id="under-title">Documentation</p>
	</header>
	</div>
	  <div id="to-cover"></div>
	<main id="main-doc">
	  <section class="main-section" id="Introduction">
	    <header id="top-header">Introduction</header>
	    <article>
	      <p>
	  ...
	  <section class="main-section" id="if...else_statement">
	    ...
	    <article>
	      ...
	      to always use block statements, especially when nesting if statements: <span id="mobile-word-opt"><i>(spaces in between underscores "_" must be removed for code to work, spaces were set for mobile optimization)...</i></span>
	
	      <code id="mobile-code-opt">if (condition) {statement _ 1 _ runs _ if _ condition _ is _ true;
	        statement _ 2 _ runs _ if _ condition _ is _ true; } else {
	        statement _ 3 _ runs _ if _ condition _ is _ false;
	        statement _ 4 _ runs _ if _ condition _ is _ false; }</code>
